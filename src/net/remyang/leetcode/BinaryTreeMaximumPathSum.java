...
public class BinaryTreeMaximumPathSum {
	...
	public static void main(String[] args) {
		TreeNode tn = new TreeNode(5, new TreeNode(4, new TreeNode(11,
				new TreeNode(7), new TreeNode(2)), null), new TreeNode(8,
				new TreeNode(13), new TreeNode(4, null, new TreeNode(1))));

		TreeNode tn2 = new TreeNode(-2, new TreeNode(6, new TreeNode(0),
				new TreeNode(-6)), null);

		TreeNode tn3 = new TreeNode(-6, null, new TreeNode(3, new TreeNode(2),
				null));
