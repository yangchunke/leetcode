...
public class SubstringWithConcatenationOfAllWords {
	...
	public static void main(String[] args) {
		...
		for (int i : c.findSubstring(
				"lingmindraboofooowingdingbarrwingmonkeypoundcake",
				new String[] { "fooo", "barr", "wing", "ding", "wing" })) {
			System.out.print(i + " ");
		}
		System.out.println("");
		for (int i : c.findSubstring("barfoothefoobarman", new String[] {
				"foo", "bar" })) {
			System.out.print(i + " ");
		}
		System.out.println("");
		...
		System.out.println("");
		for (int i : c.findSubstring("abaababbaba", new String[] { "ab", "ba",
				"ab", "ba" })) {
			System.out.print(i + " ");
		}
		System.out.println("");
				...
				if (S_Matched.containsKey(now)) {
					...
					if (used) {
						...
						while (!now.equals(prev)) {
							...
							l_matched--; // Decrease the number of matched
											// strings
